...
BOT_TOKEN = "8883240985:AAFKaT38a1IDa-_jqtfRruO59B7dSgxT2fY"

# Разные видео для разных разделов
MAIN_VIDEO = "main.mp4"  # для главного меню, поддержки, истории сделок
DEAL_VIDEO = "deal.mp4"  # для процесса создания сделки
REKV_VIDEO = "rekv.mp4"  # для управления реквизитами

SUPPORT_LINK = "https://t.me/GiftGuarantorSupport"
ADMIN_LINK = "https://t.me/SafePlayerokSup"  # Ссылка на менеджера для пополнения
...
def get_main_menu(user_id=None):
    ...
    builder.add(InlineKeyboardButton(text="💳 Реквизиты", callback_data="manage_details"))
